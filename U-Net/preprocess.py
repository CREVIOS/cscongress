...
def main():
    # Only LGG
    ## Y - Mask Annotation
    load_dataset('C:/Users/EGC/Documents/DeepHealth/MRI/dataset/train/', '**/*_seg.nii.gz', label=True, resize=(155,img_size,img_size))
    ## X - Features
    load_dataset('C:/Users/EGC/Documents/DeepHealth/MRI/dataset/train//Documents/DeepHealth/MRI/dataset/train/', '**/*_flair.nii.gz',label=False, resize=(155,img_size,img_size))
