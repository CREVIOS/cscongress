...
train_X = np.load('C:/Users/EGC/Documents/DeepHealth/MRI/x_{}.npy'.format(img_size))
train_Y = np.load('C:/Users/EGC/Documents/DeepHealth/MRI/y_{}.npy'.format(img_size))
